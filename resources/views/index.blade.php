                  ...
                  <div class="carousel-inner">
                    <div class="container">
                      <div class="carousel-caption fadeInUp animated" style="bottom:0;top:200px">
                        ...
                        <p class="h2" style="color: #ddd;padding-top:20px;padding-bottom: 20px">Love to service</p>
                      </div>
                    </div>
                    ...
                    <div class="carousel-item active" style="height: 300px">
                      <div class="container">
                        <div class="carousel-caption">
                          <h3 class="display-4" style="color:#5e493a;font-size: 40px ;">"Saya sangat senang setelah makan disini."</h3>
                          <p class="h4" style="color: gray; padding-top:20px;padding-bottom: 20px">Fahrul Rizha</p>
                        </div>
                      </div>
                    </div>
                    <div class="carousel-item" style="height: 300px">
                      <div class="container">
                        <div class="carousel-caption">
                          ...
                          <p class="h2" style="color: gray;padding-top:20px;padding-bottom: 20px">Sadiqin</p>
                        </div>
                      </div>
                    </div>
                    <div class="carousel-item" style="height: 300px">
                      <div class="container">
                        <div class="carousel-caption">
                          ...
                          <p class="h2" style="color: gray;padding-top:20px;padding-bottom: 20px">Almer</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                    ...
                    <ul>
                        <li style="padding-left: 50px;margin-bottom: 10px">
                            ...
                            Duson Payalhok, Jl. Tumpok Dalam, <br> Lhokseumawe, Aceh
                        </li>
